        ...
        if($nic != ""){
          if($pass != "" && $cpass != ""){
            if($pass == $cpass){
                ...
                $sql = "Insert Into user(Full_Name,NIC_Number,Email,Password,email_verifyed,Token,role) VALUES ('$fullName','$nic','$email','$enc_pass',0,'$token','$role')";
...
<div class="reg-container">
    ...
    <label for="role">Rol</label>
		<select name="role" class="form-control" required>Elige el rol
